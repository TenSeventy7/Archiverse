...
class TagWorksActivity extends CommonListActivity<Work> {
  const TagWorksActivity({super.key, required this.tag});
  static const String routeName = "/tag/works";
  final Tag tag;
...
class TagWorksActivityState extends CommonListActivityState<Work> {
  Tag get tag => (widget as TagWorksActivity).tag;
