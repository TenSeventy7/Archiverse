...
class AuthorWorksActivity extends CommonListActivity<Work> {
  const AuthorWorksActivity({super.key, required this.author});
  static const String routeName = "/author/works";
  final Pseud author;
...
class TagWorksActivityState extends CommonListActivityState<Work> {
  Pseud get author => (widget as AuthorWorksActivity).author;
