...
class LibraryWorksActivity extends CommonListActivity<Work> {
  const LibraryWorksActivity({super.key});
  static const String routeName = "/library/works";
...
class FolderWorksActivityState extends CommonListActivityState<Work> {
  ...
  Future<List<Work>> fetchItems(int page) async {
    return await AppApi().getWorksInLibrary(page: page);
  }
  ...
  Widget buildTitle(BuildContext context) {
    return Text("Library", maxLines: 1, overflow: TextOverflow.ellipsis);
  }
